...
from rigify.utils.bones import align_bone_roll, put_bone, copy_bone_position
from rigify.utils.naming import make_derived_name
from rigify.utils.misc import map_list
from rigify.utils.bones import align_bone_to_axis
...
class Rig(pawRig):
    ...
    def align_ik_control_bone(self, name: str):
        if self.params.rotation_axis == 'automatic' or self.params.auto_align_extremity:
            align_bone_to_axis(self.obj, name, 'y')
    ...
    def make_ik_ctrl_widget(self, ctrl):
        ...
        org = self.get_bone(self.bones.org.main[-1])
    ...
    def build_ik_pivot(self, ik_name: str, **args) -> CustomPivotControl | None:
        if self.use_ik_pivot:
            pos = self.get_bone(self.bones.org.main[-1]).tail
            return CustomPivotControl(self, 'ik_pivot', ik_name, position=pos, **args)
